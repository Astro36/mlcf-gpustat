...
apply_configmap alertmanager-config --from-file=alertmanager.yml.tmpl="$ROOT/alerting/alertmanager/alertmanager.yml.tmpl"
apply_configmap alertmanager-templates --from-file=telegram.tmpl="$ROOT/alerting/alertmanager/templates/telegram.tmpl"
apply_configmap vmalert-rules --from-file=gpu.rules="$ROOT/alerting/vmalert/gpu.rules"
...
$KUBECTL apply -f "$K3S_DIR/alertmanager.yaml"
$KUBECTL apply -f "$K3S_DIR/vmalert.yaml"
